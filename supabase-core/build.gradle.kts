...
android {
    namespace = "io.github.maskmasteruk.supabase.core"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
...
mavenPublishing {
    coordinates("io.github.maskmasteruk", "supabase-android-core", "0.0.1")

    pom {
        name.set("Supabase Core SDK for Android")
        description.set("Core Java-based Android SDK providing shared functionality for all Supabase Android libraries.")
